...
import 'package:qiita_reader/features/qiita/presentation/screens/gallery/web_chrome_addresses_settings.dart';
import 'package:settings_ui/settings_ui.dart';

import '../../widgets/navifation.dart';

class WebChromeSettings extends StatelessWidget {
  const WebChromeSettings({required Key key}) : super(key: key);
